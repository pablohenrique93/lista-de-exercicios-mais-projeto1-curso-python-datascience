# Projeto 1 - Desenvolvimento de Game em Linguagem Python - Versão 1 - Jogo da Forca
...
def display_hangman(chances):
    ...
    # Lista de estágios da forca (as contra barras em python fazem parte da síntaxe, por isso foi utlizado duas como alternativa de escape)
...
# Função que vai receber todo conteúdo do game
def game():
    ...
    while chances > 0:
        ...
        if tentativa in lista_letras_palavras:
            ...
            # Decremento (A intenção é seguir reduzindo as chances do suário a medida que ele erra)
            chances -= 1
